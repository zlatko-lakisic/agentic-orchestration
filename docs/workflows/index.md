...
- [CLI reference]({{ '/cli-reference/' | relative_url }}) — `--batch`, `-i` / `--interactive`
- [Dynamic planning]({{ '/dynamic-planning/' | relative_url }}) — alternative: no fixed YAML; planner builds ephemeral workflow
