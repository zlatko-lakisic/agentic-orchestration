...
- Harness stats in `learning_store` and planner context via `harness_performance_summary`.
...
- Agent catalog generator adds **Harness** column.
- Default pytest excludes `@pytest.mark.agent_harness`.
