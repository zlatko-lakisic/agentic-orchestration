...
permalink: /Third-party-projects/
---
...
|----------------|------------------|
| [Model Context Protocol](https://modelcontextprotocol.io/) | MCP tool attachments; catalog supports `streamable_http` and `stdio` (plus legacy `ref` / `refs`). |
| [Home Assistant](https://www.home-assistant.io/) | Official MCP integration (`home_assistant`). |
| [Brave Search](https://brave.com/search/api/) | Optional search MCP (`search_brave`; bring your HTTP endpoint). |
...
| `search_exa` | [Exa MCP](https://docs.exa.ai/reference/exa-mcp) | [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) |
