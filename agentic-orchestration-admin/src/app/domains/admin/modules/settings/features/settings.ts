...
export class SettingsPage implements OnInit {
  ...
  readonly modifiedOnly = signal(false);
  readonly restartOnly = signal(false);
  readonly includeInjected = signal(false);

  readonly filteredCount = computed(() => this.applyFilters(this.config.entries()).length);
