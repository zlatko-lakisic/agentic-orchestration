...
const NODE_BY_KIND = {
    app: {
        ...
        blurb: 'Reach appId accordion (left family) — expand for UI / overlays / local tools.',
    },
    ui: {
        wikiKey: 'ui',
    ...
    'web-api-client': {
        ...
        blurb: 'External appId with minted Access token(s) calling the Web UI API (bypass Reach).',
    },
    'session-bridge': {
    ...
    platform: {
        ...
        blurb: 'Kubernetes platform — expand for cluster nodes, pods with addresses, Services, and Service→Pod network paths.',
    },
    storage: {
        wikiKey: 'storage',
...
const NODE_BY_ID = {
    ...
    'models/ollama': {
        ...
        blurb: 'Local Ollama runtime — external URL or in-cluster agentic-ollama (AGENTIC_OLLAMA_MODE).',
    },
    'models/remote': {
    ...
    'platform/k3s': {
        wikiKey: 'platform-expand',
        blurb: 'In-cluster Kubernetes — expand the wider panel for namespace workloads.',
    },
    ...
    'k8s/workload/agentic-ollama': {
        wikiKey: 'k8s-ollama',
        blurb: 'In-cluster Ollama (managed_k8s) — Service agentic-ollama:11434; models on hostPath or NFS.',
    },
};
const EDGE_BY_KIND = {
    request: {
    ...
    bypass: {
        wikiKey: 'edge-bypass',
        blurb: 'Path that skips Reach and hits the Web UI directly (ao-web, ao-chat, OpenClaw).',
    },
};
const DEFAULT_NODE = {
