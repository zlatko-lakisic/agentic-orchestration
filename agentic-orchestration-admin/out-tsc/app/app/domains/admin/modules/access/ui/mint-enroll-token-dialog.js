...
let MintEnrollTokenDialog = class MintEnrollTokenDialog {
    api = inject(AoApi);
...
MintEnrollTokenDialog = __decorate([
    Component({
...
], MintEnrollTokenDialog);
export { MintEnrollTokenDialog };
