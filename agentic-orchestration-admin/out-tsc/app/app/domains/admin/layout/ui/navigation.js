...
import { isActive, NavigationEnd, Router, RouterLink, RouterLinkActive, } from '@angular/router';
...
let Navigation = class Navigation {
    ...
    navigationEnd = toSignal(this.router.events.pipe(filter((event) => event instanceof NavigationEnd), take(1)));
    constructor() {
