...
export const WIKI_BASE_URL = 'https://github.com/zlatko-lakisic/agentic-orchestration/wiki';
/** Default page that hosts per-variable HTML anchors (`#AGENTIC_KB`). */
export const WIKI_CONFIG_PAGE = 'Configuration';
export function wikiUrlForKey(key, page = WIKI_CONFIG_PAGE) {
    const k = String(key || '').trim();
    if (!k)
        return `${WIKI_BASE_URL}/${page}`;
