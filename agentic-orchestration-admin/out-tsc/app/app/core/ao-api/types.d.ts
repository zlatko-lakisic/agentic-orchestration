export type AoStatus = 'healthy' | 'degraded' | 'failed' | 'unset' | 'running' | 'info';
export type AoSource = 'process-env' | 'env.jetson' | 'k8s-secret' | 'yaml-catalog' | 'runtime' | 'default' | 'unknown';
export type AoApplyTier = 'live' | 'next-run' | 'next-session' | 'restart-web' | 'restart-engine' | 'redeploy';
