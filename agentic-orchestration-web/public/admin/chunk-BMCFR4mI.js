import{$t as Xy,At as Sm,Ct as Rd,Dn as cp,Dt as Rw,Et as Rv,Gt as Vi,H as Ir,Hr as tT,Ht as Ul,I as Hl,Jt as WS,Kt as Vm,Mn as dl,Mr as ql,Nn as dm,Pn as eG,Pr as qr,Qn as hC,Qr as v,Rr as sC,Rt as Ty,S as Dw,St as R,U as It$1,Un as fm,Ur as ta,Ut as V,V as Im,Vr as tH,W as JV,Wr as tg,Xn as gw,Yt as W_,Z as L,Zn as h,Zr as uy,_i as ye,a as Ae,ai as vw,b as Da,bn as av,br as mw,c as Aw,ci as wm,cr as jw,dn as _m,dt as Od,ei as vS,fi as xe$1,fn as _p,ft as Om,g as Cw,gi as yT,gt as Q,h as CC,ht as Pw,jn as de,jt as Sn,k as Fw,kr as pm,ln as _T,lt as O,mi as yC,n as $S,ni as vf,nr as im,o as Ah,or as jn,pr as ls,pt as Ow,qr as uD,r as $l,ri as vm,rn as Yw,rt as Lw,sr as js,tr as ie,tt as Ls,u as Bl,ur as km,v as DC,vi as yi$1,vn as ap,vr as mI,wi as zn,wr as oH,wt as Rn,xr as nH,yi as yw,yr as mm,yt as Qs}from"./chunk-BKuU67Ve.js";import{c as N,l as wt$1,t as Dt$1,u as yt$1,w as Lt$1}from"./main-UN4VOCDD.js";import{t as l}from"./chunk-Chq-Sr3x.js";import{n as dt,r as lt,t as Z}from"./chunk-B8VS8NNG.js";import{t as m}from"./chunk-OUjubrDb.js";import"./chunk-b-CykK3L.js";import{n as I,r as w,t as A}from"./chunk-D44MjCCg.js";import{t as I$1}from"./chunk-B0g4Zlb_.js";import"./chunk-CFnw-i3R.js";import{l as xe$2}from"./chunk-CPPTph-4.js";import"./chunk-DDK6Q_O8.js";import"./chunk-Dhf_pMfa.js";import{i as Lt$2,n as G,r as I$2,t as Bt}from"./chunk-5hTklRp-.js";var Ct=[`*`,[[`mat-chip-avatar`],[``,`matChipAvatar`,``]],[[`mat-chip-trailing-icon`],[``,`matChipRemove`,``],[``,`matChipTrailingIcon`,``]]];var wt=[`*`,`mat-chip-avatar, [matChipAvatar]`,`mat-chip-trailing-icon,[matChipRemove],[matChipTrailingIcon]`];function jt(a,n){a&1&&(Ls(0,`span`,3),Ow(1,1),Hl())}function Vt(a,n){a&1&&(Ls(0,`span`,6),Ow(1,2),Hl())}function Gt(a,n){a&1&&(Ls(0,`span`,3),Ow(1,1),Ls(2,`span`,7),_p(),Ls(3,`svg`,8),fm(4,`path`,9),Hl()()())}function qt(a,n){a&1&&(Ls(0,`span`,6),Ow(1,2),Hl())}var Qt=`.mdc-evolution-chip,
...
`;var Nt=[`*`];var Ut=`.mat-mdc-chip-set {
  display: flex;
}
...
`],encapsulation:2})}return a})();function Mt(a,n=0,e=100){return Math.max(n,Math.min(e,a))}var At=(()=>{class a{static ɵfac=function(t){return new(t||a)};static ɵmod=Ae({type:a});static ɵinj=ye({imports:[Rv]})}return a})();var Jt=[`chart`];var Ft=(()=>{class a{constructor(){this.chart=nH(),this.annotations=nH(),this.colors=nH(),this.dataLabels=nH(),this.series=nH(),this.stroke=nH(),this.labels=nH(),this.legend=nH(),this.markers=nH(),this.noData=nH(),this.parsing=nH(),this.fill=nH(),this.tooltip=nH(),this.plotOptions=nH(),this.responsive=nH(),this.xaxis=nH(),this.yaxis=nH(),this.forecastDataPoints=nH(),this.grid=nH(),this.states=nH(),this.title=nH(),this.subtitle=nH(),this.theme=nH(),this.autoUpdateSeries=nH(!0),this.chartReady=tH(),this.chartInstance=It$1(null),this.chartElement=oH.required(`chart`),this.ngZone=h(V),this.isBrowser=Ty(h(Sn)),this._destroyed=!1,this._injector=h(Q),this.waitingForConnectedRef=null}ngOnChanges(e){this.isBrowser&&this.hydrate(e)}ngOnDestroy(){this.destroy(),this._destroyed=!0}get isConnected(){return this.chartElement()?.nativeElement.isConnected}hydrate(e){if(this.waitingForConnectedRef)return;if(this.chartInstance()&&this.autoUpdateSeries()&&Object.keys(e).filter(i=>i!==`series`).length===0){this.updateSeries(this.series(),!0);return}dl({read:()=>this.createElement()},{injector:this._injector})}importApexCharts(){return import(`./chunk-B4t3fBEx.js`)}async createElement(){let{default:e}=await this.importApexCharts();if(window.ApexCharts||=e,this._destroyed)return;if(!this.isConnected){this.waitForConnected();return}let t={};[`annotations`,`chart`,`colors`,`dataLabels`,`series`,`stroke`,`labels`,`legend`,`fill`,`tooltip`,`plotOptions`,`responsive`,`markers`,`noData`,`parsing`,`xaxis`,`yaxis`,`forecastDataPoints`,`grid`,`states`,`title`,`subtitle`,`theme`].forEach(l=>{let M=this[l]();M&&(t[l]=M)}),this.destroy();let d=this.ngZone.runOutsideAngular(()=>new e(this.chartElement().nativeElement,t));this.chartInstance.set(d),this.render(),this.chartReady.emit({chartObj:d})}render(){if(this.isConnected)return this.ngZone.runOutsideAngular(()=>this.chartInstance()?.render());this.waitForConnected()}updateOptions(e,t,i,d){return this.ngZone.runOutsideAngular(()=>this.chartInstance()?.updateOptions(e,t,i,d))}updateSeries(e,t){return this.ngZone.runOutsideAngular(()=>this.chartInstance()?.updateSeries(e,t))}appendSeries(e,t){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.appendSeries(e,t))}appendData(e){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.appendData(e))}highlightSeries(e){return this.ngZone.runOutsideAngular(()=>this.chartInstance()?.highlightSeries(e))}toggleSeries(e){return this.ngZone.runOutsideAngular(()=>this.chartInstance()?.toggleSeries(e))}showSeries(e){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.showSeries(e))}hideSeries(e){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.hideSeries(e))}resetSeries(){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.resetSeries())}zoomX(e,t){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.zoomX(e,t))}toggleDataPointSelection(e,t){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.toggleDataPointSelection(e,t))}destroy(){this.chartInstance()?.destroy(),this.chartInstance.set(null)}setLocale(e){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.setLocale(e))}paper(){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.paper())}addXaxisAnnotation(e,t,i){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.addXaxisAnnotation(e,t,i))}addYaxisAnnotation(e,t,i){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.addYaxisAnnotation(e,t,i))}addPointAnnotation(e,t,i){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.addPointAnnotation(e,t,i))}removeAnnotation(e,t){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.removeAnnotation(e,t))}clearAnnotations(e){this.ngZone.runOutsideAngular(()=>this.chartInstance()?.clearAnnotations(e))}dataURI(e){return this.chartInstance()?.dataURI(e)}waitForConnected(){this.waitingForConnectedRef||(this.waitingForConnectedRef=W_({read:()=>{this.isConnected&&(this.waitingForConnectedRef.destroy(),this.waitingForConnectedRef=null,this.createElement())}},{injector:this._injector}))}static{this.ɵfac=function(t){return new(t||a)}}static{this.ɵcmp=jn({type:a,selectors:[[`apx-chart`]],viewQuery:function(t,i){t&1&&wm(i.chartElement,Jt,5),t&2&&Pw()},inputs:{chart:[1,`chart`],annotations:[1,`annotations`],colors:[1,`colors`],dataLabels:[1,`dataLabels`],series:[1,`series`],stroke:[1,`stroke`],labels:[1,`labels`],legend:[1,`legend`],markers:[1,`markers`],noData:[1,`noData`],parsing:[1,`parsing`],fill:[1,`fill`],tooltip:[1,`tooltip`],plotOptions:[1,`plotOptions`],responsive:[1,`responsive`],xaxis:[1,`xaxis`],yaxis:[1,`yaxis`],forecastDataPoints:[1,`forecastDataPoints`],grid:[1,`grid`],states:[1,`states`],title:[1,`title`],subtitle:[1,`subtitle`],theme:[1,`theme`],autoUpdateSeries:[1,`autoUpdateSeries`]},outputs:{chartReady:`chartReady`},features:[js],decls:2,vars:0,consts:[[`chart`,``]],template:function(t,i){t&1&&pm(0,`div`,null,0)},encapsulation:2})}}return a})();var Tt=180;var Rt=400;var Yt=2500;var ce=class a{ws=null;reconnectTimer=null;destroyed=!1;wantMetrics=!1;wantLogs=!1;logSources=null;logSeq=0;refCount=0;connected=It$1(!1);metrics=It$1(null);history=It$1([]);logs=It$1([]);logSourceOptions=It$1([`web`,`coordinator`,`engine`,`warm-pool`,`broker`]);latestCpu=CC(()=>{let n=this.metrics()?.cpu?.percent;return n==null||Number.isNaN(Number(n))?null:Number(n)});latestMem=CC(()=>{let n=this.metrics()?.memory,e=n?.usedPercent??n?.percent;return e==null||Number.isNaN(Number(e))?null:Number(e)});latestGpu=CC(()=>{let e=this.metrics()?.jetson?.gpu?.percent;return e==null||Number.isNaN(Number(e))?null:Number(e)});acquire(n){this.refCount+=1,n.metrics&&(this.wantMetrics=!0),n.logs&&(this.wantLogs=!0),n.logSources&&(this.logSources=[...n.logSources]),this.ensureConnected(),this.pushSubscriptions()}release(){this.refCount=Math.max(0,this.refCount-1),this.refCount===0&&(this.wantMetrics=!1,this.wantLogs=!1,this.closeSocket())}setLogSources(n){this.logSources=n,this.wantLogs&&this.ws?.readyState===WebSocket.OPEN&&this.ws.send(JSON.stringify({type:`admin_logs_subscribe`,sources:n?.length?n:void 0}))}clearLogs(){this.logs.set([])}ngOnDestroy(){this.destroyed=!0,this.closeSocket()}wsUrl(){let n=location.protocol===`https:`?`wss:`:`ws:`;return location.port===`3873`?`ws://127.0.0.1:3847/`:`${n}//${location.host}/`}ensureConnected(){if(!(this.destroyed||this.refCount<=0)&&!(this.ws&&(this.ws.readyState===WebSocket.OPEN||this.ws.readyState===WebSocket.CONNECTING)))try{let n=new WebSocket(this.wsUrl());this.ws=n,n.onopen=()=>{this.connected.set(!0),this.pushSubscriptions()},n.onmessage=e=>this.onMessage(e),n.onclose=()=>{this.connected.set(!1),this.ws=null,this.scheduleReconnect()},n.onerror=()=>{try{n.close()}catch{}}}catch{this.scheduleReconnect()}}pushSubscriptions(){let n=this.ws;!n||n.readyState!==WebSocket.OPEN||(this.wantMetrics&&n.send(JSON.stringify({type:`host_metrics_subscribe`})),this.wantLogs&&n.send(JSON.stringify({type:`admin_logs_subscribe`,sources:this.logSources?.length?this.logSources:void 0})))}onMessage(n){let e;try{e=JSON.parse(String(n.data||``))}catch{return}let t=String(e.type||``);if(t===`host_metrics`){let i=e;this.metrics.set(i),this.pushHistory(i);return}if(t===`admin_logs_sources`&&Array.isArray(e.sources)){this.logSourceOptions.set(e.sources.map(String));return}if(t===`admin_log`){let i={id:++this.logSeq,source:String(e.source||`web`),level:String(e.level||`info`),ts:String(e.ts||new Date().toISOString()),line:String(e.line||``)};this.logs.update(d=>{let l=[...d,i];return l.length>Rt?l.slice(l.length-Rt):l})}}pushHistory(n){let e=Date.parse(String(n.ts||``))||Date.now(),t=n.cpu?.percent==null||Number.isNaN(Number(n.cpu.percent))?null:Number(n.cpu.percent),i=n.memory?.usedPercent??n.memory?.percent,d=i==null||Number.isNaN(Number(i))?null:Number(i),M=n.jetson?.gpu?.percent,Bt=M==null||Number.isNaN(Number(M))?null:Number(M);this.history.update(zt=>{let Z=[...zt,{t:e,cpu:t,mem:d,gpu:Bt}];return Z.length>Tt?Z.slice(Z.length-Tt):Z})}scheduleReconnect(){this.destroyed||this.refCount<=0||this.reconnectTimer||(this.reconnectTimer=setTimeout(()=>{this.reconnectTimer=null,this.ensureConnected()},Yt))}closeSocket(){this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null);let n=this.ws;if(this.ws=null,this.connected.set(!1),!!n)try{n.readyState===WebSocket.OPEN&&(n.send(JSON.stringify({type:`host_metrics_unsubscribe`})),n.send(JSON.stringify({type:`admin_logs_unsubscribe`}))),n.close()}catch{}}static ɵfac=function(e){return new(e||a)};static ɵprov=R({token:a,factory:a.ɵfac,providedIn:`root`})};var ei=[`logViewport`];var Ot=()=>[];var ti=()=>[`#f59e0b`];var ii=()=>[`#60a5fa`];var ni=()=>[`#c084fc`];var ai=(a,n)=>n.title;var Pt=(a,n)=>n.id;var ri=(a,n)=>n.message;function oi(a,n){if(a&1&&fm(0,`ao-error-state`,13),a&2)dm(`message`,Aw().error())}function ci(a,n){if(a&1&&(Ls(0,`mat-card`,15)(1,`mat-card-header`)(2,`div`,59),fm(3,`mat-icon`,64),Ls(4,`div`,35),sC(5),Hl()()(),Ls(6,`mat-card-content`)(7,`div`,65),sC(8),yC(9,`number`),Hl(),Ls(10,`div`,66),fm(11,`mat-icon`,64),Ls(12,`div`,22),sC(13),Hl()()()()),a&2){let e=n.$implicit;mI(3),dm(`svgIcon`,e.icon),mI(2),Om(e.title),mI(3),ql(` `,DC(9,7,e.value),` `),mI(3),Yw(e.toneClass),dm(`svgIcon`,e.toneIcon),mI(2),ql(` `,e.caption,` `)}}function si(a,n){a&1&&(Ls(0,`span`,24),sC(1,`%`),Hl())}function li(a,n){a&1&&(Ls(0,`span`,24),sC(1,`%`),Hl())}function di(a,n){if(a&1&&(Ls(0,`div`)(1,`div`,22),sC(2,`GPU`),Hl(),Ls(3,`div`,23),sC(4),Ls(5,`span`,24),sC(6,`%`),Hl()()()),a&2){let e=Aw();mI(4),ql(` `,e.live.latestGpu())}}function pi(a,n){a&1&&(Ls(0,`mat-card`,46)(1,`div`,59),fm(2,`mat-icon`,60),Ls(3,`div`,61),sC(4,` Reach port guard `),Hl()(),Ls(5,`div`,67),fm(6,`mat-icon`,68),Ls(7,`div`,6),sC(8),Hl()()()),a&2&&(mI(8),Om(n.message))}function mi(a,n){if(a&1&&(Ls(0,`mat-card`,46)(1,`div`,59),fm(2,`mat-icon`,69),Ls(3,`div`,61),sC(4,` Sparkline snapshots `),Hl()(),Ls(5,`div`,70)(6,`div`)(7,`div`,71),sC(8,`CPU`),Hl(),fm(9,`apx-chart`,72),Hl(),Ls(10,`div`)(11,`div`,71),sC(12,`Memory`),Hl(),fm(13,`apx-chart`,72),Hl(),Ls(14,`div`)(15,`div`,71),sC(16,`GPU`),Hl(),fm(17,`apx-chart`,72),Hl()()()),a&2){let e=Aw();mI(9),dm(`chart`,e.sparkChart.chart)(`colors`,hC(18,ti))(`fill`,e.sparkChart.fill)(`series`,e.sparkSeries(`cpu`))(`stroke`,e.sparkChart.stroke)(`tooltip`,e.sparkChart.tooltip),mI(4),dm(`chart`,e.sparkChart.chart)(`colors`,hC(19,ii))(`fill`,e.sparkChart.fill)(`series`,e.sparkSeries(`mem`))(`stroke`,e.sparkChart.stroke)(`tooltip`,e.sparkChart.tooltip),mI(4),dm(`chart`,e.sparkChart.chart)(`colors`,hC(20,ni))(`fill`,e.sparkChart.fill)(`series`,e.sparkSeries(`gpu`))(`stroke`,e.sparkChart.stroke)(`tooltip`,e.sparkChart.tooltip)}}function hi(a,n){a&1&&(Ls(0,`a`,82),sC(1,` Open `),Hl()),a&2&&dm(`href`,n,tg)}function ui(a,n){a&1&&(Ls(0,`div`,87)(1,`a`,88),sC(2,` Open `),Hl()()),a&2&&(mI(),dm(`href`,n,tg))}function gi(a,n){if(a&1){let e=Cw();Ls(0,`mat-card`,49)(1,`div`,73),fm(2,`mat-icon`,74),Hl(),Ls(3,`div`,75)(4,`div`,76)(5,`div`,61),sC(6),Hl(),Ls(7,`div`,77),sC(8),Hl()(),Ls(9,`div`,78)(10,`button`,79),fm(11,`mat-icon`,80),Hl(),Ls(12,`mat-menu`,null,1)(14,`button`,81),vm(`click`,function(){ap(e);return cp(Aw().reload())}),sC(15,` Refresh `),Hl(),gw(16,hi,2,1,`a`,82),Hl()()(),Ls(17,`div`,83)(18,`div`,84)(19,`div`,22),sC(20,`Port`),Hl(),Ls(21,`div`,85),sC(22),Hl()(),Ls(23,`div`,84)(24,`div`,22),sC(25,`NodePort`),Hl(),Ls(26,`div`,85),sC(27),Hl()(),Ls(28,`div`,76)(29,`div`,22),sC(30,`Detail`),Hl(),Ls(31,`div`,86),sC(32),Hl()()(),gw(33,ui,3,1,`div`,87),Hl()}if(a&2){let e,t,i=n.$implicit,d=jw(13),l=Aw();mI(2),dm(`ngClass`,l.watermarkClass(i.status))(`svgIcon`,l.watermarkIcon(i.status)),mI(4),ql(` `,i.label,` `),mI(),dm(`ngClass`,l.statusTextClass(i.status)),mI(),ql(` `,l.statusLabel(i.status),` `),mI(2),dm(`matMenuTriggerFor`,d),mI(6),mw((e=l.componentHref(i))?16:-1,e),mI(6),ql(` `,i.port??`—`,` `),mI(5),ql(` `,i.nodePort??`—`,` `),mI(5),ql(` `,i.fact||i.detail||`—`,` `),mI(),mw((t=l.componentHref(i))?33:-1,t)}}function vi(a,n){a&1&&(Ls(0,`mat-card`,50)(1,`div`,6),sC(2,`No topology components reported`),Hl()())}function fi(a,n){if(a&1&&(Ls(0,`mat-chip-option`,56),sC(1),Hl()),a&2){let e=n.$implicit;dm(`value`,e),mI(),Om(e)}}function _i(a,n){if(a&1&&(Ls(0,`div`,58)(1,`span`,89),sC(2),Hl(),Ls(3,`span`,90),sC(4),Hl(),Ls(5,`span`,91),sC(6),Hl()()),a&2){let e=n.$implicit,t=Aw();mI(2),Om(t.formatLogTime(e.ts)),mI(),dm(`ngClass`,t.sourceClass(e.source)),mI(),Om(e.source),mI(),dm(`ngClass`,t.levelClass(e.level)),mI(),Om(e.line)}}function yi(a,n){a&1&&(Ls(0,`div`,6),sC(1,`Waiting for log lines…`),Hl())}function bi(a,n){if(a&1&&(Ls(0,`a`,93),sC(1,` Open `),Hl()),a&2){let e=Aw().$implicit;dm(`routerLink`,e.href)}}function Si(a,n){if(a&1&&(Ls(0,`div`,63),fm(1,`mat-icon`,92),Ls(2,`div`,18)(3,`div`,6),sC(4),Hl(),gw(5,bi,2,1,`a`,93),Hl()()),a&2){let e=n.$implicit;mI(),dm(`svgIcon`,e.severity===`warning`?`octagon-alert`:`circle-alert`),mI(3),Om(e.message),mI(),mw(e.href?5:-1)}}function xi(a,n){a&1&&(Ls(0,`div`,63),fm(1,`mat-icon`,94),Ls(2,`div`,6),sC(3,`Nothing flagged`),Hl()())}var Lt=class a{api=h(l);theming=h(Lt$1);live=h(ce);logViewport=oH(`logViewport`);topology=It$1(null);ping=It$1(null);session=It$1(null);error=It$1(null);selectedSources=It$1([]);components=CC(()=>this.topology()?.components||[]);filteredLogs=CC(()=>{let n=new Set(this.selectedSources()),e=this.live.logs();return n.size?e.filter(t=>n.has(t.source)):e});chartSeries=CC(()=>{let n=this.live.history(),e=[{name:`CPU`,data:n.map(t=>({x:t.t,y:t.cpu==null?null:Number(t.cpu.toFixed(1))}))},{name:`Memory`,data:n.map(t=>({x:t.t,y:t.mem==null?null:Number(t.mem.toFixed(1))}))}];return n.some(t=>t.gpu!=null)&&e.push({name:`GPU`,data:n.map(t=>({x:t.t,y:t.gpu==null?null:Number(t.gpu.toFixed(1))}))}),e});summary=CC(()=>{let n=this.components(),e=n.filter(l=>[`healthy`,`available`,`succeeded`].includes(String(l.status||``).toLowerCase())).length,t=n.filter(l=>[`degraded`,`warning`,`running`,`reconciling`].includes(String(l.status||``).toLowerCase())).length,i=n.filter(l=>[`failed`,`blocking`].includes(String(l.status||``).toLowerCase())).length,d=this.topology()?.attention?.length??0;return[{title:`Healthy`,icon:`circle-check`,value:e,caption:`components up`,toneIcon:`arrow-up`,toneClass:`text-green-600`},{title:`Degraded`,icon:`octagon-alert`,value:t,caption:`need watch`,toneIcon:t?`arrow-up`:`arrow-down`,toneClass:t?`text-amber-600`:`text-green-600`},{title:`Failed`,icon:`circle-x`,value:i,caption:`blocking`,toneIcon:i?`arrow-up`:`arrow-down`,toneClass:i?`text-red-600`:`text-green-600`},{title:`Attention`,icon:`bell`,value:d,caption:`open items`,toneIcon:d?`arrow-up`:`arrow-down`,toneClass:d?`text-amber-600`:`text-green-600`}]});utilChart={chart:{animations:{enabled:!1},fontFamily:`inherit`,foreColor:`inherit`,height:`100%`,type:`area`,toolbar:{show:!1},zoom:{enabled:!1}},colors:[`#f59e0b`,`#60a5fa`,`#c084fc`],dataLabels:{enabled:!1},fill:{type:`gradient`,gradient:{shadeIntensity:.4,opacityFrom:.45,opacityTo:.05,stops:[0,90,100]}},grid:{borderColor:`rgba(148, 163, 184, 0.2)`,strokeDashArray:3,padding:{left:8,right:8}},legend:{show:!0,position:`top`,horizontalAlign:`right`},stroke:{curve:`smooth`,width:2},tooltip:CC(()=>({theme:this.theming.isDark()?`dark`:`light`,x:{format:`HH:mm:ss`},y:{formatter:n=>`${Number(n).toFixed(1)}%`}})),xaxis:{type:`datetime`,labels:{datetimeUTC:!1,style:{colors:`var(--mat-sys-on-surface)`}},axisBorder:{show:!1},tooltip:{enabled:!1}},yaxis:{min:0,max:100,tickAmount:4,labels:{formatter:n=>`${Math.round(n)}%`,style:{colors:`var(--mat-sys-on-surface)`}}}};sparkChart={chart:{animations:{enabled:!1},fontFamily:`inherit`,foreColor:`inherit`,height:`101%`,width:`101%`,type:`area`,sparkline:{enabled:!0}},fill:{type:`gradient`,gradient:{shadeIntensity:.5,opacityFrom:.4,opacityTo:.05}},stroke:{curve:`smooth`,width:2},tooltip:{enabled:!1}};constructor(){ls(()=>{this.filteredLogs(),queueMicrotask(()=>{let n=this.logViewport()?.nativeElement;n&&(n.scrollTop=n.scrollHeight)})})}ngOnInit(){this.selectedSources.set([...this.live.logSourceOptions()]),this.live.acquire({metrics:!0,logs:!0}),this.reload()}ngOnDestroy(){this.live.release()}sparkSeries(n){let e=this.live.history().map(t=>t[n]).filter(t=>t!=null);return[{name:n,data:e.length?e:[0]}]}onSourcesChange(n){let e=n.value,t=Array.isArray(e)?e:e?[e]:[];this.selectedSources.set(t),this.live.setLogSources(t.length?t:null)}reload(){this.error.set(null),this.api.topology().subscribe(n=>{n.ok?this.topology.set(n.data):this.error.set(n.message)}),this.api.ping().subscribe(n=>n.ok&&this.ping.set(n.data)),this.api.session().subscribe(n=>n.ok&&this.session.set(n.data))}componentHref(n){let e=n.url||n.urlHint;if(!e)return null;let t=location.hostname||`127.0.0.1`,i=String(e).replace(/__HOST__/g,t).replace(/<host>/gi,t).split(/\s+/)[0];return!i||i.includes(`<`)?null:i.startsWith(`/`)?`${location.protocol}//${location.host}${i}`:i}resourceBarColor(n){return n==null?`primary`:n>=90?`error`:n>=75?`warn`:`primary`}statusLabel(n){let e=String(n||`unknown`).replace(/-/g,` `);return e.charAt(0).toUpperCase()+e.slice(1)}statusTextClass(n){let e=String(n||``).toLowerCase();return[`healthy`,`available`,`succeeded`].includes(e)?`text-green-600`:[`failed`,`blocking`].includes(e)?`text-red-600`:[`degraded`,`warning`,`running`,`reconciling`].includes(e)?`text-amber-600`:`text-neutral-500`}watermarkIcon(n){let e=String(n||``).toLowerCase();return[`healthy`,`available`,`succeeded`].includes(e)?`circle-check`:[`failed`,`blocking`].includes(e)?`circle-x`:`circle-alert`}watermarkClass(n){let e=String(n||``).toLowerCase();return[`healthy`,`available`,`succeeded`].includes(e)?`text-green-600/25 dark:text-green-500/25`:[`failed`,`blocking`].includes(e)?`text-red-600/25 dark:text-red-500/25`:`text-amber-600/25 dark:text-amber-500/25`}formatUptime(n){if(n==null||!Number.isFinite(n))return`—`;let e=Math.floor(n),t=Math.floor(e/86400),i=Math.floor(e%86400/3600),d=Math.floor(e%3600/60);return t>0?`${t}d ${i}h`:i>0?`${i}h ${d}m`:`${d}m`}formatLogTime(n){let e=new Date(n);return Number.isFinite(e.getTime())?e.toLocaleTimeString([],{hour12:!1,hour:`2-digit`,minute:`2-digit`,second:`2-digit`}):`--:--:--`}sourceClass(n){switch(n){case`engine`:return`text-violet-400`;case`coordinator`:return`text-sky-400`;case`warm-pool`:return`text-amber-400`;case`broker`:return`text-rose-400`;default:return`text-emerald-400`}}levelClass(n){return n===`error`?`text-red-300`:n===`warn`?`text-amber-200`:`text-neutral-200`}static ɵfac=function(e){return new(e||a)};static ɵcmp=jn({type:a,selectors:[[`ao-overview-page`]],viewQuery:function(e,t){e&1&&wm(t.logViewport,ei,5),e&2&&Pw()},decls:140,vars:41,consts:[[`logViewport`,``],[`compMenu`,`matMenu`],[1,`@container`,`mx-auto`,`flex`,`w-full`,`max-w-7xl`,`flex-auto`,`flex-col`,`gap-4`,`p-6`,`sm:gap-6`,`lg:px-8`,`lg:pt-8`,`lg:pb-10`],[1,`flex`,`items-center`,`justify-between`,`gap-x-3`],[1,`flex`,`flex-col`,`gap-y-0.5`],[1,`text-xl`,`font-semibold`,`tracking-tighter`,`sm:text-2xl`],[1,`text-neutral-500`],[1,`flex-auto`],[1,`flex`,`items-center`,`gap-x-3`],[1,`hidden`,`items-center`,`gap-x-1.5`,`text-sm`,`sm:flex`,3,`ngClass`],[1,`inline-block`,`size-2`,`rounded-full`,3,`ngClass`],[`matButton`,`outlined`,`type`,`button`,1,`hidden`,`sm:inline-flex`,3,`click`],[`svgIcon`,`refresh-cw`],[3,`message`],[1,`grid`,`gap-4`,`sm:gap-6`,`@max-md:grid-cols-1`,`@md:grid-cols-2`,`@4xl:grid-cols-4`],[`appearance`,`filled`],[`appearance`,`outlined`,1,`overflow-hidden`],[1,`flex`,`flex-col`,`gap-y-1`,`px-5`,`pt-5`,`sm:flex-row`,`sm:items-start`],[1,`min-w-0`,`flex-auto`],[1,`text-lg`,`font-medium`,`tracking-tight`],[1,`font-medium`,`text-neutral-500`],[1,`mt-3`,`flex`,`flex-wrap`,`gap-x-6`,`gap-y-2`,`sm:mt-0`],[1,`text-sm`,`font-medium`,`text-neutral-500`],[1,`text-3xl`,`font-semibold`,`tabular-nums`,`tracking-tighter`],[1,`text-lg`,`text-neutral-500`],[1,`mt-2`,`flex`,`flex-auto`,`flex-col`,`px-2`,`pb-2`],[1,`h-72`,`w-full`,3,`chart`,`colors`,`dataLabels`,`fill`,`grid`,`legend`,`series`,`stroke`,`tooltip`,`xaxis`,`yaxis`],[1,`flex`,`flex-wrap`,`gap-x-8`,`gap-y-3`,`px-5`,`py-4`,`text-sm`],[1,`font-mono`,`tabular-nums`],[1,`min-w-40`,`flex-auto`],[`mode`,`determinate`,1,`mt-1`,`rounded-full`,3,`color`,`value`],[1,`grid`,`w-full`,`grid-cols-1`,`gap-6`,`xl:grid-cols-2`],[`appearance`,`filled`,1,`flex`,`flex-col`],[1,`flex`,`flex-auto`,`items-center`,`gap-x-2`],[`svgIcon`,`server`,1,`size-4`],[1,`font-medium`,`tracking-tight`],[1,`ml-auto`],[`matButton`,``,`href`,`/`],[1,`flex`,`flex-auto`,`flex-col`],[1,`text-3xl`,`font-semibold`],[1,`mt-0.5`,`text-sm`,`text-neutral-500`],[1,`mt-4`,`flex`,`flex-col`,`gap-y-3`],[1,`flex`,`items-center`,`gap-x-1`],[1,`font-medium`,`tabular-nums`],[1,`max-w-[60%]`,`truncate`,`font-mono`,`text-sm`,`font-medium`],[1,`font-medium`],[`appearance`,`outlined`,1,`p-6`],[1,`mt-2`,`w-full`],[1,`grid`,`w-full`,`grid-cols-1`,`gap-6`,`sm:grid-cols-2`,`xl:grid-cols-2`],[`appearance`,`outlined`,1,`relative`,`overflow-hidden`,`px-5`,`py-4`],[`appearance`,`outlined`,1,`px-5`,`py-8`],[1,`flex`,`flex-col`,`gap-3`,`px-5`,`py-4`,`sm:flex-row`,`sm:items-center`],[1,`text-sm`,`text-neutral-500`],[`matButton`,`outlined`,`type`,`button`,3,`click`],[1,`px-5`,`pb-3`],[`aria-label`,`Log sources`,3,`change`,`multiple`,`value`],[3,`value`],[1,`max-h-96`,`overflow-y-auto`,`bg-neutral-950`,`px-4`,`py-3`,`font-mono`,`text-xs`,`leading-relaxed`,`text-neutral-200`],[1,`flex`,`gap-x-2`,`whitespace-pre-wrap`,`break-all`],[1,`flex`,`items-center`,`gap-x-2`],[`svgIcon`,`sparkles`,1,`size-5`,`text-primary-600`,`dark:text-primary-500`],[1,`truncate`,`text-lg`,`font-medium`,`tracking-tight`],[1,`mt-6`,`flex`,`flex-col`,`gap-y-4`],[1,`flex`,`items-start`,`gap-x-3`],[1,`size-4`,3,`svgIcon`],[1,`text-5xl`,`font-semibold`,`tabular-nums`],[1,`mt-2`,`flex`,`items-center`,`gap-x-1`],[1,`mt-4`,`flex`,`items-start`,`gap-x-3`],[`svgIcon`,`octagon-alert`,1,`size-5`,`shrink-0`,`text-neutral-500`],[`svgIcon`,`activity`,1,`size-5`,`text-primary-600`,`dark:text-primary-500`],[1,`mt-4`,`grid`,`grid-cols-3`,`gap-3`],[1,`text-xs`,`font-medium`,`text-neutral-500`],[1,`h-16`,3,`chart`,`colors`,`fill`,`series`,`stroke`,`tooltip`],[1,`absolute`,`right-0`,`bottom-0`,`-m-6`,`h-24`,`w-24`],[1,`size-24`,3,`ngClass`,`svgIcon`],[1,`flex`,`items-center`],[1,`flex`,`min-w-0`,`flex-col`],[1,`text-sm`,`font-medium`,3,`ngClass`],[1,`-mt-2`,`ml-auto`],[`mat-icon-button`,``,`type`,`button`,3,`matMenuTriggerFor`],[`svgIcon`,`ellipsis`],[`mat-menu-item`,``,`type`,`button`,3,`click`],[`mat-menu-item`,``,`target`,`_blank`,`rel`,`noopener`,3,`href`],[1,`mt-4`,`flex`,`flex-row`,`flex-wrap`,`gap-6`],[1,`flex`,`flex-col`],[1,`text-3xl`,`font-medium`,`tabular-nums`],[1,`max-w-56`,`truncate`,`text-sm`,`text-neutral-500`],[1,`mt-3`],[`matButton`,``,`target`,`_blank`,`rel`,`noopener`,3,`href`],[1,`shrink-0`,`text-neutral-500`],[1,`w-24`,`shrink-0`,`truncate`,`font-semibold`,3,`ngClass`],[3,`ngClass`],[1,`size-5`,`shrink-0`,`text-neutral-500`,3,`svgIcon`],[`matButton`,``,1,`mt-1`,3,`routerLink`],[`svgIcon`,`circle-check`,1,`size-5`,`shrink-0`,`text-green-600`]],template:function(e,t){if(e&1&&(Ls(0,`div`,2)(1,`div`,3)(2,`div`,4)(3,`div`,5),sC(4,` Overview `),Hl(),Ls(5,`div`,6),sC(6,` Live host utilization, topology, and streaming logs `),Hl()(),fm(7,`div`,7),Ls(8,`div`,8)(9,`div`,9),fm(10,`span`,10),sC(11),Hl(),Ls(12,`button`,11),vm(`click`,function(){return t.reload()}),fm(13,`mat-icon`,12),sC(14,` Refresh `),Hl()()(),gw(15,oi,1,1,`ao-error-state`,13),Ls(16,`div`,14),vw(17,ci,14,9,`mat-card`,15,ai),Hl(),Ls(19,`mat-card`,16)(20,`div`,17)(21,`div`,18)(22,`div`,19),sC(23,` Host utilization `),Hl(),Ls(24,`div`,20),sC(25),Hl()(),Ls(26,`div`,21)(27,`div`)(28,`div`,22),sC(29,`CPU`),Hl(),Ls(30,`div`,23),sC(31),gw(32,si,2,0,`span`,24),Hl()(),Ls(33,`div`)(34,`div`,22),sC(35,`Memory`),Hl(),Ls(36,`div`,23),sC(37),gw(38,li,2,0,`span`,24),Hl()(),gw(39,di,7,1,`div`),Hl()(),Ls(40,`div`,25),fm(41,`apx-chart`,26),Hl(),fm(42,`mat-divider`),Ls(43,`div`,27)(44,`div`)(45,`div`,20),sC(46,`Load`),Hl(),Ls(47,`div`,28),sC(48),Hl()(),Ls(49,`div`)(50,`div`,20),sC(51,`Uptime`),Hl(),Ls(52,`div`,28),sC(53),Hl()(),Ls(54,`div`)(55,`div`,20),sC(56,`Cores`),Hl(),Ls(57,`div`,28),sC(58),Hl()(),Ls(59,`div`,29)(60,`div`,20),sC(61,`CPU`),Hl(),fm(62,`mat-progress-bar`,30),Hl(),Ls(63,`div`,29)(64,`div`,20),sC(65,`Memory`),Hl(),fm(66,`mat-progress-bar`,30),Hl()()(),Ls(67,`div`,31)(68,`mat-card`,32)(69,`mat-card-header`)(70,`div`,33),fm(71,`mat-icon`,34),Ls(72,`div`,35),sC(73,`Web process`),Hl(),Ls(74,`div`,36)(75,`a`,37),sC(76,` Open chat `),Hl()()()(),Ls(77,`mat-card-content`,38)(78,`div`,39),sC(79),Hl(),Ls(80,`div`,40),sC(81,` Coordinator web UI and Admin API process `),Hl(),Ls(82,`div`,41)(83,`div`,42)(84,`div`,6),sC(85,`pid`),Hl(),fm(86,`div`,7),Ls(87,`div`,43),sC(88),Hl()(),Ls(89,`div`,42)(90,`div`,6),sC(91,`instance`),Hl(),fm(92,`div`,7),Ls(93,`div`,44),sC(94),Hl()(),Ls(95,`div`,42)(96,`div`,6),sC(97,`user`),Hl(),fm(98,`div`,7),Ls(99,`div`,45),sC(100),Hl()()()()(),gw(101,pi,9,1,`mat-card`,46)(102,mi,18,21,`mat-card`,46),Hl(),Ls(103,`div`,47)(104,`div`,5),sC(105,` Topology `),Hl(),Ls(106,`div`,6),sC(107,` Runtime components and how they are exposed on this host `),Hl()(),Ls(108,`div`,48),vw(109,gi,34,11,`mat-card`,49,Pt,!1,vi,3,0,`mat-card`,50),Hl(),Ls(112,`mat-card`,16)(113,`div`,51)(114,`div`,18)(115,`div`,19),sC(116,`Live logs`),Hl(),Ls(117,`div`,52),sC(118,` Streaming from web + kubectl tails when available `),Hl()(),Ls(119,`button`,53),vm(`click`,function(){return t.live.clearLogs()}),sC(120,` Clear `),Hl()(),Ls(121,`div`,54)(122,`mat-chip-listbox`,55),vm(`change`,function(d){return t.onSourcesChange(d)}),vw(123,fi,2,2,`mat-chip-option`,56,yw),Hl()(),fm(125,`mat-divider`),Ls(126,`div`,57,0),vw(128,_i,7,5,`div`,58,Pt,!1,yi,2,0,`div`,6),Hl()(),Ls(131,`mat-card`,46)(132,`div`,59),fm(133,`mat-icon`,60),Ls(134,`div`,61),sC(135,` Needs attention `),Hl()(),Ls(136,`div`,62),vw(137,Si,6,3,`div`,63,ri,!1,xi,4,0,`div`,63),Hl()()()),e&2){let i;mI(9),dm(`ngClass`,t.live.connected()?`text-green-600`:`text-neutral-500`),mI(),dm(`ngClass`,t.live.connected()?`bg-green-500 animate-pulse`:`bg-neutral-400`),mI(),ql(` `,t.live.connected()?`Live`:`Reconnecting…`,` `),mI(4),mw(t.error()?15:-1),mI(2),Dw(t.summary()),mI(8),km(` `,t.live.metrics()?.hostname||`Coordinator host`,` · scope `,t.live.metrics()?.scope||`—`,` · WebSocket push ~2s `),mI(6),ql(` `,t.live.latestCpu()??`—`),mI(),mw(t.live.latestCpu()!=null?32:-1),mI(5),ql(` `,t.live.latestMem()??`—`),mI(),mw(t.live.latestMem()!=null?38:-1),mI(),mw(t.live.latestGpu()!=null?39:-1),mI(2),dm(`chart`,t.utilChart.chart)(`colors`,t.utilChart.colors)(`dataLabels`,t.utilChart.dataLabels)(`fill`,t.utilChart.fill)(`grid`,t.utilChart.grid)(`legend`,t.utilChart.legend)(`series`,t.chartSeries())(`stroke`,t.utilChart.stroke)(`tooltip`,t.utilChart.tooltip())(`xaxis`,t.utilChart.xaxis)(`yaxis`,t.utilChart.yaxis),mI(7),ql(` `,(t.live.metrics()?.loadAvg||hC(39,Ot)).join(` · `)||`—`,` `),mI(5),ql(` `,t.formatUptime(t.live.metrics()?.uptimeSec),` `),mI(5),ql(` `,t.live.metrics()?.cpu?.cores??`—`,` `),mI(4),dm(`color`,t.resourceBarColor(t.live.latestCpu()))(`value`,t.live.latestCpu()??0),mI(4),dm(`color`,t.resourceBarColor(t.live.latestMem()))(`value`,t.live.latestMem()??0),mI(13),ql(` `,t.ping()?.service||`—`,` `),mI(9),ql(` `,t.ping()?.pid??`—`,` `),mI(6),ql(` `,t.ping()?.instance||`—`,` `),mI(6),ql(` `,t.session()?.userName||`—`,` `),mI(),mw((i=t.topology()?.reachGuard)?101:102,i),mI(8),Dw(t.components()),mI(13),dm(`multiple`,!0)(`value`,t.selectedSources()),mI(),Dw(t.live.logSourceOptions()),mI(5),Dw(t.filteredLogs()),mI(9),Dw(t.topology()?.attention||hC(40,Ot))}},dependencies:[Dt$1,I$1,lt,dt,Z,yt$1,wt$1,Lt$2,I$2,G,Bt,w,I,A,m,At,Dt,we,Ce,yT,Ft,_T],encapsulation:2})};export{Lt as OverviewPage};