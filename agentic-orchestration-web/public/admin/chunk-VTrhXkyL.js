import{$r as tE,An as cb,Bn as ea,Bt as WG,Dt as TC,Ei as ye,Gn as fD,Ht as Wn,Ir as pd,It as Va,Jn as fd,Kt as Xm,Lt as Vm,Mt as Ue,Nn as cf,Rn as dd,St as Rr,W as Jv,Y as L,Yt as Xs,Z as Lt,Zr as sC,_i as wC,_n as ag,_t as Qp,ci as uf,di as v,dn as aC,dr as jr,dt as P,er as h,g as Da,i as $y,ji as zm,kr as ny,lr as jm,mr as ki,ni as ty,ot as Ny,pr as ke$1,q as KT,qr as rr,qt as Xn,rn as Z,rr as ha,si as ud,st as O$1,un as _y,ut as Or,v as Dn,wt as SC,xn as bC,xr as le,yi as wt,yn as ay,zr as qm}from"./chunk-BP7ZfSiu.js";import{a as k,s}from"./chunk-CjCMmbjo.js";import{r as p}from"./chunk-D4IygM-y.js";var O=new v(`CdkAccordion`);var he=(()=>{class t{_stateChanges=new L;_openCloseAllActions=new L;id=h(uf).getId(`cdk-accordion-`);multi=!1;openAll(){this.multi&&this._openCloseAllActions.next(!0)}closeAll(){this._openCloseAllActions.next(!1)}ngOnChanges(e){this._stateChanges.next(e)}ngOnDestroy(){this._stateChanges.complete(),this._openCloseAllActions.complete()}static ɵfac=function(n){return new(n||t)};static ɵdir=Ue({type:t,selectors:[[`cdk-accordion`],[``,`cdkAccordion`,``]],inputs:{multi:[2,`multi`,`multi`,Da]},exportAs:[`cdkAccordion`],features:[_y([{provide:O,useExisting:t}]),ea]})}return t})();var ge=(()=>{class t{accordion=h(O,{optional:!0,skipSelf:!0});_changeDetectorRef=h($y);_expansionDispatcher=h(p);_openCloseAllSubscription=Z.EMPTY;closed=new ye;opened=new ye;destroyed=new ye;expandedChange=new ye;id=h(uf).getId(`cdk-accordion-child-`);get expanded(){return this._expanded}set expanded(e){if(this._expanded!==e){if(this._expanded=e,this.expandedChange.emit(e),e){this.opened.emit();let n=this.accordion?this.accordion.id:this.id;this._expansionDispatcher.notify(this.id,n)}else this.closed.emit();this._changeDetectorRef.markForCheck()}}_expanded=!1;get disabled(){return this._disabled()}set disabled(e){this._disabled.set(e)}_disabled=Lt(!1);_removeUniqueSelectionListener=()=>{};ngOnInit(){this._removeUniqueSelectionListener=this._expansionDispatcher.listen((e,n)=>{this.accordion&&!this.accordion.multi&&this.accordion.id===n&&this.id!==e&&(this.expanded=!1)}),this.accordion&&(this._openCloseAllSubscription=this._subscribeToOpenCloseAllActions())}ngOnDestroy(){this.opened.complete(),this.closed.complete(),this.destroyed.emit(),this.destroyed.complete(),this._removeUniqueSelectionListener(),this._openCloseAllSubscription.unsubscribe()}toggle(){this.disabled||(this.expanded=!this.expanded)}close(){this.disabled||(this.expanded=!1)}open(){this.disabled||(this.expanded=!0)}_subscribeToOpenCloseAllActions(){return this.accordion._openCloseAllActions.subscribe(e=>{this.disabled||(this.expanded=e)})}static ɵfac=function(n){return new(n||t)};static ɵdir=Ue({type:t,selectors:[[`cdk-accordion-item`],[``,`cdkAccordionItem`,``]],inputs:{expanded:[2,`expanded`,`expanded`,Da],disabled:[2,`disabled`,`disabled`,Da]},outputs:{closed:`closed`,opened:`opened`,destroyed:`destroyed`,expandedChange:`expandedChange`},exportAs:[`cdkAccordionItem`],features:[_y([{provide:O,useValue:void 0}])]})}return t})();var Se=[`body`];var Ce=[`bodyWrapper`];var Ee=[[[`mat-expansion-panel-header`]],`*`,[[`mat-action-row`]]];var Ne=[`mat-expansion-panel-header`,`*`,`mat-action-row`];function Me(t,fe){}var Ae=[[[`mat-panel-title`]],[[`mat-panel-description`]],`*`];var De=[`mat-panel-title`,`mat-panel-description`,`*`];function Pe(t,fe){t&1&&(fd(0,`span`,1),Qp(),fd(1,`svg`,2),qm(2,`path`,3),pd()())}var F=new v(`MAT_ACCORDION`);var ue=new v(`MAT_EXPANSION_PANEL`);var ke=(()=>{class t{_template=h(Rr);_expansionPanel=h(ue,{optional:!0});static ɵfac=function(n){return new(n||t)};static ɵdir=Ue({type:t,selectors:[[`ng-template`,`matExpansionPanelContent`,``]]})}return t})();var xe=new v(`MAT_EXPANSION_PANEL_DEFAULT_OPTIONS`);var Te=(()=>{class t extends ge{_viewContainerRef=h(jr);_animationsDisabled=Va();_document=h(O$1);_ngZone=h(P);_elementRef=h(le);_renderer=h(Or);_cleanupTransitionEnd;get hideToggle(){return this._hideToggle||this.accordion&&this.accordion.hideToggle}set hideToggle(e){this._hideToggle=e}_hideToggle=!1;get togglePosition(){return this._togglePosition||this.accordion&&this.accordion.togglePosition}set togglePosition(e){this._togglePosition=e}_togglePosition;afterExpand=new ye;afterCollapse=new ye;_inputChanges=new L;accordion=h(F,{optional:!0,skipSelf:!0});_lazyContent;_body;_bodyWrapper;_portal;_headerId=h(uf).getId(`mat-expansion-panel-header-`);constructor(){super();let e=h(xe,{optional:!0});this._expansionDispatcher=h(p),e&&(this.hideToggle=e.hideToggle)}_hasSpacing(){return this.accordion?this.expanded&&this.accordion.displayMode==="default":!1}_getExpandedState(){return this.expanded?`expanded`:`collapsed`}toggle(){this.expanded=!this.expanded}close(){this.expanded=!1}open(){this.expanded=!0}ngAfterContentInit(){this._lazyContent&&this._lazyContent._expansionPanel===this&&this.opened.pipe(ki(null),ke$1(()=>this.expanded&&!this._portal),wt(1)).subscribe(()=>{this._portal=new s(this._lazyContent._template,this._viewContainerRef)}),this._setupAnimationEvents()}ngOnChanges(e){this._inputChanges.next(e)}ngOnDestroy(){super.ngOnDestroy(),this._cleanupTransitionEnd?.(),this._inputChanges.complete()}_containsFocus(){if(this._body){let e=this._document.activeElement,n=this._body.nativeElement;return e===n||n.contains(e)}return!1}_transitionEndListener=({target:e,propertyName:n})=>{e===this._bodyWrapper?.nativeElement&&n===`grid-template-rows`&&this._ngZone.run(()=>{this.expanded?this.afterExpand.emit():this.afterCollapse.emit()})};_setupAnimationEvents(){this._ngZone.runOutsideAngular(()=>{this._animationsDisabled?(this.opened.subscribe(()=>this._ngZone.run(()=>this.afterExpand.emit())),this.closed.subscribe(()=>this._ngZone.run(()=>this.afterCollapse.emit()))):setTimeout(()=>{let e=this._elementRef.nativeElement;this._cleanupTransitionEnd=this._renderer.listen(e,`transitionend`,this._transitionEndListener),e.classList.add(`mat-expansion-panel-animations-enabled`)},200)})}static ɵfac=function(n){return new(n||t)};static ɵcmp=Xn({type:t,selectors:[[`mat-expansion-panel`]],contentQueries:function(n,a,r){if(n&1&&ty(r,ke,5),n&2){let o;TC(o=SC())&&(a._lazyContent=o.first)}},viewQuery:function(n,a){if(n&1&&ny(Se,5)(Ce,5),n&2){let r;TC(r=SC())&&(a._body=r.first),TC(r=SC())&&(a._bodyWrapper=r.first)}},hostAttrs:[1,`mat-expansion-panel`],hostVars:4,hostBindings:function(n,a){n&2&&ha(`mat-expanded`,a.expanded)(`mat-expansion-panel-spacing`,a._hasSpacing())},inputs:{hideToggle:[2,`hideToggle`,`hideToggle`,Da],togglePosition:`togglePosition`},outputs:{afterExpand:`afterExpand`,afterCollapse:`afterCollapse`},exportAs:[`matExpansionPanel`],features:[_y([{provide:F,useValue:void 0},{provide:ue,useExisting:t}]),jm,ea],ngContentSelectors:Ne,decls:9,vars:4,consts:[[`bodyWrapper`,``],[`body`,``],[1,`mat-expansion-panel-content-wrapper`],[`role`,`region`,1,`mat-expansion-panel-content`,3,`id`],[1,`mat-expansion-panel-body`],[3,`cdkPortalOutlet`]],template:function(n,a){n&1&&(bC(Ee),wC(0),Xs(1,`div`,2,0)(3,`div`,3,1)(5,`div`,4),wC(6,1),Vm(7,Me,0,0,`ng-template`,5),dd(),wC(8,2),dd()()),n&2&&(cb(),ud(`inert`,a.expanded?null:``),cb(2),zm(`id`,a.id),ud(`aria-labelledby`,a._headerId),cb(4),zm(`cdkPortalOutlet`,a._portal))},dependencies:[k],styles:[`.mat-expansion-panel {
...
`],encapsulation:2})}return t})();var Ie=(()=>{class t{panel=h(Te,{host:!0});_element=h(le);_focusMonitor=h(Jv);_changeDetectorRef=h($y);_parentChangeSubscription=Z.EMPTY;constructor(){h(rr).load(WG);let e=this.panel,n=h(xe,{optional:!0}),a=h(new Ny(`tabindex`),{optional:!0}),r=e.accordion?e.accordion._stateChanges.pipe(ke$1(o=>!!(o.hideToggle||o.togglePosition))):Dn;this.tabIndex=parseInt(a||``)||0,this._parentChangeSubscription=tE(e.opened,e.closed,r,e._inputChanges.pipe(ke$1(o=>!!(o.hideToggle||o.disabled||o.togglePosition)))).subscribe(()=>this._changeDetectorRef.markForCheck()),e.closed.pipe(ke$1(()=>e._containsFocus())).subscribe(()=>this._focusMonitor.focusVia(this._element,`program`)),n&&(this.expandedHeight=n.expandedHeight,this.collapsedHeight=n.collapsedHeight)}expandedHeight;collapsedHeight;tabIndex=0;get disabled(){return this.panel.disabled}_toggle(){this.disabled||this.panel.toggle()}_isExpanded(){return this.panel.expanded}_getExpandedState(){return this.panel._getExpandedState()}_getPanelId(){return this.panel.id}_getTogglePosition(){return this.panel.togglePosition}_showToggle(){return!this.panel.hideToggle&&!this.panel.disabled}_getHeaderHeight(){let e=this._isExpanded();return e&&this.expandedHeight?this.expandedHeight:!e&&this.collapsedHeight?this.collapsedHeight:null}_keydown(e){switch(e.keyCode){case 32:case 13:fD(e)||(e.preventDefault(),this._toggle());break;default:this.panel.accordion&&this.panel.accordion._handleHeaderKeydown(e);return}}focus(e,n){e?this._focusMonitor.focusVia(this._element,e,n):this._element.nativeElement.focus(n)}ngAfterViewInit(){this._focusMonitor.monitor(this._element).subscribe(e=>{e&&this.panel.accordion&&this.panel.accordion._handleHeaderFocus(this)})}ngOnDestroy(){this._parentChangeSubscription.unsubscribe(),this._focusMonitor.stopMonitoring(this._element)}static ɵfac=function(n){return new(n||t)};static ɵcmp=Xn({type:t,selectors:[[`mat-expansion-panel-header`]],hostAttrs:[`role`,`button`,1,`mat-expansion-panel-header`,`mat-focus-indicator`],hostVars:13,hostBindings:function(n,a){n&1&&Xm(`click`,function(){return a._toggle()})(`keydown`,function(o){return a._keydown(o)}),n&2&&(ud(`id`,a.panel._headerId)(`tabindex`,a.disabled?-1:a.tabIndex)(`aria-controls`,a._getPanelId())(`aria-expanded`,a._isExpanded())(`aria-disabled`,a.panel.disabled),ay(`height`,a._getHeaderHeight()),ha(`mat-expanded`,a._isExpanded())(`mat-expansion-toggle-indicator-after`,a._getTogglePosition()===`after`)(`mat-expansion-toggle-indicator-before`,a._getTogglePosition()===`before`))},inputs:{expandedHeight:`expandedHeight`,collapsedHeight:`collapsedHeight`,tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?0:KT(e)]},ngContentSelectors:De,decls:5,vars:3,consts:[[1,`mat-content`],[1,`mat-expansion-indicator`],[`xmlns`,`http://www.w3.org/2000/svg`,`viewBox`,`0 -960 960 960`,`aria-hidden`,`true`,`focusable`,`false`],[`d`,`M480-345 240-585l56-56 184 184 184-184 56 56-240 240Z`]],template:function(n,a){n&1&&(bC(Ae),fd(0,`span`,0),wC(1),wC(2,1),wC(3,2),pd(),sC(4,Pe,3,0,`span`,1)),n&2&&(ha(`mat-content-hide-toggle`,!a._showToggle()),cb(4),aC(a._showToggle()?4:-1))},styles:[`.mat-expansion-panel-header {
  display: flex;
  flex-direction: row;
  align-items: center;
  padding: 0 24px;
...
`],encapsulation:2})}return t})();var mn=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵdir=Ue({type:t,selectors:[[`mat-panel-description`]],hostAttrs:[1,`mat-expansion-panel-header-description`]})}return t})();var hn=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵdir=Ue({type:t,selectors:[[`mat-panel-title`]],hostAttrs:[1,`mat-expansion-panel-header-title`]})}return t})();var gn=(()=>{class t extends he{_keyManager;_ownHeaders=new Wn;_headers;hideToggle=!1;displayMode=`default`;togglePosition=`after`;ngAfterContentInit(){this._headers.changes.pipe(ki(this._headers)).subscribe(e=>{this._ownHeaders.reset(e.filter(n=>n.panel.accordion===this)),this._ownHeaders.notifyOnChanges()}),this._keyManager=new cf(this._ownHeaders).withWrap().withHomeAndEnd()}_handleHeaderKeydown(e){this._keyManager.onKeydown(e)}_handleHeaderFocus(e){this._keyManager.updateActiveItem(e)}ngOnDestroy(){super.ngOnDestroy(),this._keyManager?.destroy(),this._ownHeaders.destroy()}static ɵfac=(()=>{let e;return function(a){return(e||(e=ag(t)))(a||t)}})();static ɵdir=Ue({type:t,selectors:[[`mat-accordion`]],contentQueries:function(n,a,r){if(n&1&&ty(r,Ie,5),n&2){let o;TC(o=SC())&&(a._headers=o)}},hostAttrs:[1,`mat-accordion`],hostVars:2,hostBindings:function(n,a){n&2&&ha(`mat-accordion-multi`,a.multi)},inputs:{hideToggle:[2,`hideToggle`,`hideToggle`,Da],displayMode:`displayMode`,togglePosition:`togglePosition`},exportAs:[`matAccordion`],features:[_y([{provide:F,useExisting:t}]),jm]})}return t})();export{mn as a,hn as i,Te as n,gn as r,Ie as t};