...
`],encapsulation:2})}return a})();function Ne(a,k){if(a&1&&(Xs(0,`p`,8),QC(1),dd()),a&2){let e=_C();cb(),yd(` Showing `,e.filteredCount(),` after client filters (table shows full store; use search in command palette for flash-to-row). `)}}var fe=class a{api=h(d);config=h(c);query=Lt(``);modifiedOnly=Lt(!1);restartOnly=Lt(!1);includeInjected=Lt(!1);filteredCount=ET(()=>this.applyFilters(this.config.entries()).length);ngOnInit(){this.config.load()}onQuery(){}toggleInjected(k){this.includeInjected.set(k),this.api.effectiveConfig({includeInjected:k}).subscribe(e=>{e.ok&&this.config.entries.set(e.data)})}applyFilters(k){let e=k,n=this.query().trim().toLowerCase();return n&&(e=e.filter(c=>c.key.toLowerCase().includes(n)||String(c.label||``).toLowerCase().includes(n)||String(c.effective??c.value??``).toLowerCase().includes(n))),this.modifiedOnly()&&(e=e.filter(c=>c.set&&c.source!=="default")),this.restartOnly()&&(e=e.filter(c=>{let t=String(c.tier||c.applyTier||``).toLowerCase();return t.includes(`restart`)||t===`redeploy`})),e}static ɵfac=function(e){return new(e||a)};static ɵcmp=Xn({type:a,selectors:[[`ao-settings-page`]],decls:19,vars:7,consts:[[1,`mx-auto`,`flex`,`w-full`,`max-w-7xl`,`flex-auto`,`flex-col`,`gap-4`,`p-6`,`lg:px-8`,`lg:pt-8`,`lg:pb-10`],[1,`text-xl`,`font-semibold`,`tracking-tighter`,`sm:text-2xl`],[1,`text-neutral-500`],[1,`flex`,`flex-wrap`,`items-center`,`gap-4`],[`appearance`,`outline`,`subscriptSizing`,`dynamic`,1,`min-w-64`],[`matInput`,``,`placeholder`,`key or value`,3,`ngModelChange`,`ngModel`],[3,`change`,`checked`],[3,`title`,`groups`],[1,`text-sm`,`text-neutral-500`]],template:function(e,n){e&1&&(Xs(0,`div`,0)(1,`div`)(2,`div`,1),QC(3,` All settings `),dd(),Xs(4,`div`,2),QC(5,` Every key with provenance — injected Kubernetes env hidden by default `),dd()(),Xs(6,`div`,3)(7,`mat-form-field`,4)(8,`mat-label`),QC(9,`Filter`),dd(),Xs(10,`input`,5),vy(`ngModelChange`,function(t){return rT(n.query,t)||(n.query=t),t}),Xm(`ngModelChange`,function(){return n.onQuery()}),dd(),Yb(),dd(),Xs(11,`mat-checkbox`,6),Xm(`change`,function(t){return n.modifiedOnly.set(t.checked)}),QC(12,` Modified from default `),dd(),Xs(13,`mat-checkbox`,6),Xm(`change`,function(t){return n.restartOnly.set(t.checked)}),QC(14,` Requires restart `),dd(),Xs(15,`mat-checkbox`,6),Xm(`change`,function(t){return n.toggleInjected(t.checked)}),QC(16,` Show injected environment `),dd()(),Wm(17,`ao-config-settings-table`,7),sC(18,Ne,2,1,`p`,8),dd()),e&2&&(cb(10),yy(`ngModel`,n.query),Qb(),cb(),zm(`checked`,n.modifiedOnly()),cb(2),zm(`checked`,n.restartOnly()),cb(2),zm(`checked`,n.includeInjected()),cb(2),zm(`title`,null)(`groups`,null),cb(),aC(n.query()||n.modifiedOnly()||n.restartOnly()?18:-1))},dependencies:[J,_n,Pe,mn,Ht,lt,pe,Rt,ge,je],encapsulation:2})};export{fe as SettingsPage};