import{$t as Xm,At as SC,C as Ey,Dr as or,Gt as Ve,Hr as rs,Ht as Uy,K as Jn,L as ID,Ln as ea,Mi as zm,Nn as dd,Nt as TC,Oi as ye,Q as Km,Qn as h,Tr as ny,Tt as RC,Wt as Va,Yt as Wm,Zt as XT,_r as lf,_t as P,at as My,bt as QG,cn as ZG,ct as Ne,ei as ub,en as Xp,er as ha,ni as ue,oi as v,ot as NC,q as Jp,r as AC,t as $C,ti as ud,tn as Xs,tt as Lt,ui as va}from"./chunk-_jepUChT.js";import{x as m}from"./main-RH7UG47M.js";import{d as se,o as O}from"./chunk-Ce0FHNzE.js";var W=[`input`];var Y=[`label`];var ee=[`*`];var f={color:`accent`,clickAction:`check-indeterminate`,disabledInteractive:!1};var ce=new v(`mat-checkbox-default-options`,{providedIn:`root`,factory:()=>f});var a=(function(t){return t[t.Init=0]=`Init`,t[t.Checked=1]=`Checked`,t[t.Unchecked=2]=`Unchecked`,t[t.Indeterminate=3]=`Indeterminate`,t})(a||{});var g=class{source;checked};var ne=(()=>{class t{_elementRef=h(ue);_changeDetectorRef=h(Uy);_ngZone=h(P);_animationsDisabled=Va();_options=h(ce,{optional:!0});focus(){this._inputElement.nativeElement.focus()}_createChangeEvent(e){let n=new g;return n.source=this,n.checked=e,n}_getAnimationTargetElement(){return this._inputElement?.nativeElement}_animationClasses={uncheckedToChecked:`mdc-checkbox--anim-unchecked-checked`,uncheckedToIndeterminate:`mdc-checkbox--anim-unchecked-indeterminate`,checkedToUnchecked:`mdc-checkbox--anim-checked-unchecked`,checkedToIndeterminate:`mdc-checkbox--anim-checked-indeterminate`,indeterminateToChecked:`mdc-checkbox--anim-indeterminate-checked`,indeterminateToUnchecked:`mdc-checkbox--anim-indeterminate-unchecked`};ariaLabel=``;ariaLabelledby=null;ariaDescribedby;ariaExpanded;ariaControls;ariaOwns;_uniqueId;id;get inputId(){return`${this.id||this._uniqueId}-input`}required=!1;labelPosition=`after`;name=null;change=new ye;indeterminateChange=new ye;value;disableRipple=!1;_inputElement;_labelElement;tabIndex;color;disabledInteractive;_onTouched=()=>{};_currentAnimationClass=``;_currentCheckState=a.Init;_controlValueAccessorChangeFn=()=>{};_validatorChangeFn=()=>{};constructor(){h(or).load(QG);let e=h(new My(`tabindex`),{optional:!0});this._options=this._options||f,this.color=this._options.color||f.color,this.tabIndex=e==null?0:parseInt(e)||0,this.id=this._uniqueId=h(lf).getId(`mat-mdc-checkbox-`),this.disabledInteractive=this._options?.disabledInteractive??!1}ngOnChanges(e){e.required&&this._validatorChangeFn()}ngAfterViewInit(){this._syncIndeterminate(this.indeterminate)}get checked(){return this._checked}set checked(e){e!=this.checked&&(this._checked=e,this._changeDetectorRef.markForCheck())}_checked=!1;get disabled(){return this._disabled}set disabled(e){e!==this.disabled&&(this._disabled=e,this._changeDetectorRef.markForCheck())}_disabled=!1;get indeterminate(){return this._indeterminate()}set indeterminate(e){let n=e!=this._indeterminate();this._indeterminate.set(e),n&&(e?this._transitionCheckState(a.Indeterminate):this._transitionCheckState(this.checked?a.Checked:a.Unchecked),this.indeterminateChange.emit(e)),this._syncIndeterminate(e)}_indeterminate=Lt(!1);_isRippleDisabled(){return this.disableRipple||this.disabled}_onLabelTextChange(){this._changeDetectorRef.detectChanges()}writeValue(e){this.checked=!!e}registerOnChange(e){this._controlValueAccessorChangeFn=e}registerOnTouched(e){this._onTouched=e}setDisabledState(e){this.disabled=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorChangeFn=e}_transitionCheckState(e){let n=this._currentCheckState,c=this._getAnimationTargetElement();if(!(n===e||!c)&&(this._currentAnimationClass&&c.classList.remove(this._currentAnimationClass),this._currentAnimationClass=this._getAnimationClassForCheckStateTransition(n,e),this._currentCheckState=e,this._currentAnimationClass.length>0)){c.classList.add(this._currentAnimationClass);let o=this._currentAnimationClass;this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{c.classList.remove(o)},1e3)})}}_emitChangeEvent(){this._controlValueAccessorChangeFn(this.checked),this.change.emit(this._createChangeEvent(this.checked)),this._inputElement&&(this._inputElement.nativeElement.checked=this.checked)}toggle(){this.checked=!this.checked,this._controlValueAccessorChangeFn(this.checked)}_handleInputClick(){let e=this._options?.clickAction;!this.disabled&&e!==`noop`?(this.indeterminate&&e!==`check`&&Promise.resolve().then(()=>{this._indeterminate.set(!1),this.indeterminateChange.emit(!1)}),this._checked=!this._checked,this._transitionCheckState(this._checked?a.Checked:a.Unchecked),this._emitChangeEvent()):(this.disabled&&this.disabledInteractive||!this.disabled&&e===`noop`)&&(this._inputElement.nativeElement.checked=this.checked,this._inputElement.nativeElement.indeterminate=this.indeterminate)}_onInteractionEvent(e){e.stopPropagation()}_onBlur(){Promise.resolve().then(()=>{this._onTouched(),this._changeDetectorRef.markForCheck()})}_getAnimationClassForCheckStateTransition(e,n){if(this._animationsDisabled)return``;switch(e){case a.Init:if(n===a.Checked)return this._animationClasses.uncheckedToChecked;if(n==a.Indeterminate)return this._checked?this._animationClasses.checkedToIndeterminate:this._animationClasses.uncheckedToIndeterminate;break;case a.Unchecked:return n===a.Checked?this._animationClasses.uncheckedToChecked:this._animationClasses.uncheckedToIndeterminate;case a.Checked:return n===a.Unchecked?this._animationClasses.checkedToUnchecked:this._animationClasses.checkedToIndeterminate;case a.Indeterminate:return n===a.Checked?this._animationClasses.indeterminateToChecked:this._animationClasses.indeterminateToUnchecked}return``}_syncIndeterminate(e){let n=this._inputElement;n&&(n.nativeElement.indeterminate=e)}_onInputClick(){this._handleInputClick()}_onTouchTargetClick(){this._handleInputClick(),this.disabled||this._inputElement.nativeElement.focus()}_preventBubblingFromLabel(e){e.target&&this._labelElement.nativeElement.contains(e.target)&&e.stopPropagation()}static ɵfac=function(n){return new(n||t)};static ɵcmp=Jn({type:t,selectors:[[`mat-checkbox`]],viewQuery:function(n,c){if(n&1&&ny(W,5)(Y,5),n&2){let o;NC(o=AC())&&(c._inputElement=o.first),NC(o=AC())&&(c._labelElement=o.first)}},hostAttrs:[1,`mat-mdc-checkbox`],hostVars:16,hostBindings:function(n,c){n&2&&(Km(`id`,c.id),ud(`tabindex`,null)(`aria-label`,null)(`aria-labelledby`,null),$C(c.color?`mat-`+c.color:`mat-accent`),ha(`_mat-animation-noopable`,c._animationsDisabled)(`mdc-checkbox--disabled`,c.disabled)(`mat-mdc-checkbox-disabled`,c.disabled)(`mat-mdc-checkbox-checked`,c.checked)(`mat-mdc-checkbox-disabled-interactive`,c.disabledInteractive))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],ariaExpanded:[2,`aria-expanded`,`ariaExpanded`,va],ariaControls:[0,`aria-controls`,`ariaControls`],ariaOwns:[0,`aria-owns`,`ariaOwns`],id:`id`,required:[2,`required`,`required`,va],labelPosition:`labelPosition`,name:`name`,value:`value`,disableRipple:[2,`disableRipple`,`disableRipple`,va],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?void 0:XT(e)],color:`color`,disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,va],checked:[2,`checked`,`checked`,va],disabled:[2,`disabled`,`disabled`,va],indeterminate:[2,`indeterminate`,`indeterminate`,va]},outputs:{change:`change`,indeterminateChange:`indeterminateChange`},exportAs:[`matCheckbox`],features:[Ey([{provide:se,useExisting:rs(()=>t),multi:!0},{provide:O,useExisting:t,multi:!0}]),ea],ngContentSelectors:ee,decls:15,vars:23,consts:[[`checkbox`,``],[`input`,``],[`label`,``],[`mat-internal-form-field`,``,3,`click`,`labelPosition`],[1,`mdc-checkbox`],[`aria-hidden`,`true`,1,`mat-mdc-checkbox-touch-target`,3,`click`],[`type`,`checkbox`,1,`mdc-checkbox__native-control`,3,`blur`,`click`,`change`,`checked`,`indeterminate`,`disabled`,`id`,`required`,`tabIndex`],[`aria-hidden`,`true`,1,`mdc-checkbox__ripple`],[`aria-hidden`,`true`,1,`mdc-checkbox__background`],[`focusable`,`false`,`viewBox`,`0 0 24 24`,1,`mdc-checkbox__checkmark`],[`fill`,`none`,`d`,`M1.73,12.91 8.1,19.28 22.79,4.59`,1,`mdc-checkbox__checkmark-path`],[1,`mdc-checkbox__mixedmark`],[`mat-ripple`,``,`aria-hidden`,`true`,1,`mat-mdc-checkbox-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-label`,3,`for`]],template:function(n,c){if(n&1&&(TC(),Xs(0,`div`,3),Xm(`click`,function(k){return c._preventBubblingFromLabel(k)}),Xs(1,`div`,4,0)(3,`div`,5),Xm(`click`,function(){return c._onTouchTargetClick()}),dd(),Xs(4,`input`,6,1),Xm(`blur`,function(){return c._onBlur()})(`click`,function(){return c._onInputClick()})(`change`,function(k){return c._onInteractionEvent(k)}),dd(),Wm(6,`div`,7),Xs(7,`div`,8),Xp(),Xs(8,`svg`,9),Wm(9,`path`,10),dd(),Jp(),Wm(10,`div`,11),dd(),Wm(11,`div`,12),dd(),Xs(12,`label`,13,2),SC(14),dd()()),n&2){let o=RC(2);zm(`labelPosition`,c.labelPosition),ub(4),ha(`mdc-checkbox--selected`,c.checked),zm(`checked`,c.checked)(`indeterminate`,c.indeterminate)(`disabled`,c.disabled&&!c.disabledInteractive)(`id`,c.inputId)(`required`,c.required)(`tabIndex`,c.disabled&&!c.disabledInteractive?-1:c.tabIndex),ud(`aria-label`,c.ariaLabel||null)(`aria-labelledby`,c.ariaLabelledby)(`aria-describedby`,c.ariaDescribedby)(`aria-checked`,c.indeterminate?`mixed`:null)(`aria-controls`,c.ariaControls)(`aria-disabled`,c.disabled&&c.disabledInteractive?!0:null)(`aria-expanded`,c.ariaExpanded)(`aria-owns`,c.ariaOwns)(`name`,c.name)(`value`,c.value),ub(7),zm(`matRippleTrigger`,o)(`matRippleDisabled`,c.disableRipple||c.disabled)(`matRippleCentered`,!0),ub(),zm(`for`,c.inputId)}},dependencies:[ZG,m],styles:[`.mdc-checkbox {
...
`],encapsulation:2})}return t})();var ve=(()=>{class t{static ɵfac=function(n){return new(n||t)};static ɵmod=Ve({type:t});static ɵinj=Ne({imports:[ne,ID]})}return t})();export{ve as n,ne as t};