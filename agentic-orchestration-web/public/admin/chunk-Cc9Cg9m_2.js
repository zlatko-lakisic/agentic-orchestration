...
`],encapsulation:2})}return a})();function _t(a,n=0,e=100){return Math.max(n,Math.min(e,a))}var bt=(()=>{class a{static ɵfac=function(t){return new(t||a)};static ɵmod=xe({type:a});static ɵinj=Ee({imports:[Uv]})}return a})();var zt=`# Thermal operating ranges for AO host-metrics charts (Celsius).
