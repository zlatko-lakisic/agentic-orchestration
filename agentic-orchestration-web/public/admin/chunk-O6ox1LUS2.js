import{Ar as oC,Cr as md,Dn as cd,Ei as yy,G as Ks,Gt as Xp,Kn as fa,Kt as Xs,M as IC,Or as ny,Qt as Yb,Rr as qT,Rt as Wm,T as HG,U as Km,Ut as Xm,Vn as eT,Wr as rr,Wt as Xn,Xn as h,Y as Lt,Yt as YC,_r as ld,bt as SC,ci as uf,ct as P,ei as ts,et as My,in as _C,jt as Uy,ki as zm,l as DC,li as v,o as CC,pi as wC,pn as ab,pt as Qp,rr as iC,si as ue,sr as jC,ut as Pa,v as Ey,wi as ye$1,wr as my,x as GG,xi as yT,xr as ma,zr as qb}from"./chunk-BSP5txkv.js";import"./chunk-KL__mmzy.js";import{b as ge,u as m,v as Rt}from"./main-GPIZ2PTC.js";import"./chunk-c-QCRSmx.js";import{d as se,l as _n,o as O,r as Ht,s as Pe,u as mn}from"./chunk-CvDTfDKe.js";import{r as lt}from"./chunk-BPq-DBwM.js";import"./chunk-B35pY3Lf.js";import"./chunk-BIdVRixk.js";import"./chunk-DRBRVH7A.js";import"./chunk-BoT-5Ktl.js";import{t as d}from"./chunk-B_azdExJ.js";import{t as c}from"./chunk-BpoQdGQc.js";import"./chunk-Bq4KID7w.js";import"./chunk-BXQmTEYl.js";import"./chunk-Bqe-kJ66.js";import"./chunk-CCbzIVCp.js";import"./chunk-DSrDufE9.js";import"./chunk-D5g6fDdi.js";import{t as J}from"./chunk-47HyMb1a.js";import{n as je}from"./chunk-CBzAIDDs.js";var ve=[`input`];var ye=[`label`];var Se=[`*`];var C={color:`accent`,clickAction:`check-indeterminate`,disabledInteractive:!1};var Ce=new v(`mat-checkbox-default-options`,{providedIn:`root`,factory:()=>C});var r=(function(a){return a[a.Init=0]=`Init`,a[a.Checked=1]=`Checked`,a[a.Unchecked=2]=`Unchecked`,a[a.Indeterminate=3]=`Indeterminate`,a})(r||{});var N=class{source;checked};var pe=(()=>{class a{_elementRef=h(ue);_changeDetectorRef=h(Uy);_ngZone=h(P);_animationsDisabled=Pa();_options=h(Ce,{optional:!0});focus(){this._inputElement.nativeElement.focus()}_createChangeEvent(e){let n=new N;return n.source=this,n.checked=e,n}_getAnimationTargetElement(){return this._inputElement?.nativeElement}_animationClasses={uncheckedToChecked:`mdc-checkbox--anim-unchecked-checked`,uncheckedToIndeterminate:`mdc-checkbox--anim-unchecked-indeterminate`,checkedToUnchecked:`mdc-checkbox--anim-checked-unchecked`,checkedToIndeterminate:`mdc-checkbox--anim-checked-indeterminate`,indeterminateToChecked:`mdc-checkbox--anim-indeterminate-checked`,indeterminateToUnchecked:`mdc-checkbox--anim-indeterminate-unchecked`};ariaLabel=``;ariaLabelledby=null;ariaDescribedby;ariaExpanded;ariaControls;ariaOwns;_uniqueId;id;get inputId(){return`${this.id||this._uniqueId}-input`}required=!1;labelPosition=`after`;name=null;change=new ye$1;indeterminateChange=new ye$1;value;disableRipple=!1;_inputElement;_labelElement;tabIndex;color;disabledInteractive;_onTouched=()=>{};_currentAnimationClass=``;_currentCheckState=r.Init;_controlValueAccessorChangeFn=()=>{};_validatorChangeFn=()=>{};constructor(){h(rr).load(GG);let e=h(new My(`tabindex`),{optional:!0});this._options=this._options||C,this.color=this._options.color||C.color,this.tabIndex=e==null?0:parseInt(e)||0,this.id=this._uniqueId=h(uf).getId(`mat-mdc-checkbox-`),this.disabledInteractive=this._options?.disabledInteractive??!1}ngOnChanges(e){e.required&&this._validatorChangeFn()}ngAfterViewInit(){this._syncIndeterminate(this.indeterminate)}get checked(){return this._checked}set checked(e){e!=this.checked&&(this._checked=e,this._changeDetectorRef.markForCheck())}_checked=!1;get disabled(){return this._disabled}set disabled(e){e!==this.disabled&&(this._disabled=e,this._changeDetectorRef.markForCheck())}_disabled=!1;get indeterminate(){return this._indeterminate()}set indeterminate(e){let n=e!=this._indeterminate();this._indeterminate.set(e),n&&(e?this._transitionCheckState(r.Indeterminate):this._transitionCheckState(this.checked?r.Checked:r.Unchecked),this.indeterminateChange.emit(e)),this._syncIndeterminate(e)}_indeterminate=Lt(!1);_isRippleDisabled(){return this.disableRipple||this.disabled}_onLabelTextChange(){this._changeDetectorRef.detectChanges()}writeValue(e){this.checked=!!e}registerOnChange(e){this._controlValueAccessorChangeFn=e}registerOnTouched(e){this._onTouched=e}setDisabledState(e){this.disabled=e}validate(e){return this.required&&e.value!==!0?{required:!0}:null}registerOnValidatorChange(e){this._validatorChangeFn=e}_transitionCheckState(e){let n=this._currentCheckState,c=this._getAnimationTargetElement();if(!(n===e||!c)&&(this._currentAnimationClass&&c.classList.remove(this._currentAnimationClass),this._currentAnimationClass=this._getAnimationClassForCheckStateTransition(n,e),this._currentCheckState=e,this._currentAnimationClass.length>0)){c.classList.add(this._currentAnimationClass);let t=this._currentAnimationClass;this._ngZone.runOutsideAngular(()=>{setTimeout(()=>{c.classList.remove(t)},1e3)})}}_emitChangeEvent(){this._controlValueAccessorChangeFn(this.checked),this.change.emit(this._createChangeEvent(this.checked)),this._inputElement&&(this._inputElement.nativeElement.checked=this.checked)}toggle(){this.checked=!this.checked,this._controlValueAccessorChangeFn(this.checked)}_handleInputClick(){let e=this._options?.clickAction;!this.disabled&&e!==`noop`?(this.indeterminate&&e!==`check`&&Promise.resolve().then(()=>{this._indeterminate.set(!1),this.indeterminateChange.emit(!1)}),this._checked=!this._checked,this._transitionCheckState(this._checked?r.Checked:r.Unchecked),this._emitChangeEvent()):(this.disabled&&this.disabledInteractive||!this.disabled&&e===`noop`)&&(this._inputElement.nativeElement.checked=this.checked,this._inputElement.nativeElement.indeterminate=this.indeterminate)}_onInteractionEvent(e){e.stopPropagation()}_onBlur(){Promise.resolve().then(()=>{this._onTouched(),this._changeDetectorRef.markForCheck()})}_getAnimationClassForCheckStateTransition(e,n){if(this._animationsDisabled)return``;switch(e){case r.Init:if(n===r.Checked)return this._animationClasses.uncheckedToChecked;if(n==r.Indeterminate)return this._checked?this._animationClasses.checkedToIndeterminate:this._animationClasses.uncheckedToIndeterminate;break;case r.Unchecked:return n===r.Checked?this._animationClasses.uncheckedToChecked:this._animationClasses.uncheckedToIndeterminate;case r.Checked:return n===r.Unchecked?this._animationClasses.checkedToUnchecked:this._animationClasses.checkedToIndeterminate;case r.Indeterminate:return n===r.Checked?this._animationClasses.indeterminateToChecked:this._animationClasses.indeterminateToUnchecked}return``}_syncIndeterminate(e){let n=this._inputElement;n&&(n.nativeElement.indeterminate=e)}_onInputClick(){this._handleInputClick()}_onTouchTargetClick(){this._handleInputClick(),this.disabled||this._inputElement.nativeElement.focus()}_preventBubblingFromLabel(e){e.target&&this._labelElement.nativeElement.contains(e.target)&&e.stopPropagation()}static ɵfac=function(n){return new(n||a)};static ɵcmp=Xn({type:a,selectors:[[`mat-checkbox`]],viewQuery:function(n,c){if(n&1&&ny(ve,5)(ye,5),n&2){let t;wC(t=CC())&&(c._inputElement=t.first),wC(t=CC())&&(c._labelElement=t.first)}},hostAttrs:[1,`mat-mdc-checkbox`],hostVars:16,hostBindings:function(n,c){n&2&&(Km(`id`,c.id),cd(`tabindex`,null)(`aria-label`,null)(`aria-labelledby`,null),jC(c.color?`mat-`+c.color:`mat-accent`),fa(`_mat-animation-noopable`,c._animationsDisabled)(`mdc-checkbox--disabled`,c.disabled)(`mat-mdc-checkbox-disabled`,c.disabled)(`mat-mdc-checkbox-checked`,c.checked)(`mat-mdc-checkbox-disabled-interactive`,c.disabledInteractive))},inputs:{ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],ariaExpanded:[2,`aria-expanded`,`ariaExpanded`,ma],ariaControls:[0,`aria-controls`,`ariaControls`],ariaOwns:[0,`aria-owns`,`ariaOwns`],id:`id`,required:[2,`required`,`required`,ma],labelPosition:`labelPosition`,name:`name`,value:`value`,disableRipple:[2,`disableRipple`,`disableRipple`,ma],tabIndex:[2,`tabIndex`,`tabIndex`,e=>e==null?void 0:qT(e)],color:`color`,disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,ma],checked:[2,`checked`,`checked`,ma],disabled:[2,`disabled`,`disabled`,ma],indeterminate:[2,`indeterminate`,`indeterminate`,ma]},outputs:{change:`change`,indeterminateChange:`indeterminateChange`},exportAs:[`matCheckbox`],features:[Ey([{provide:se,useExisting:ts(()=>a),multi:!0},{provide:O,useExisting:a,multi:!0}]),Xs],ngContentSelectors:Se,decls:15,vars:23,consts:[[`checkbox`,``],[`input`,``],[`label`,``],[`mat-internal-form-field`,``,3,`click`,`labelPosition`],[1,`mdc-checkbox`],[`aria-hidden`,`true`,1,`mat-mdc-checkbox-touch-target`,3,`click`],[`type`,`checkbox`,1,`mdc-checkbox__native-control`,3,`blur`,`click`,`change`,`checked`,`indeterminate`,`disabled`,`id`,`required`,`tabIndex`],[`aria-hidden`,`true`,1,`mdc-checkbox__ripple`],[`aria-hidden`,`true`,1,`mdc-checkbox__background`],[`focusable`,`false`,`viewBox`,`0 0 24 24`,1,`mdc-checkbox__checkmark`],[`fill`,`none`,`d`,`M1.73,12.91 8.1,19.28 22.79,4.59`,1,`mdc-checkbox__checkmark-path`],[1,`mdc-checkbox__mixedmark`],[`mat-ripple`,``,`aria-hidden`,`true`,1,`mat-mdc-checkbox-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-label`,3,`for`]],template:function(n,c){if(n&1&&(_C(),Ks(0,`div`,3),Xm(`click`,function(p){return c._preventBubblingFromLabel(p)}),Ks(1,`div`,4,0)(3,`div`,5),Xm(`click`,function(){return c._onTouchTargetClick()}),ld(),Ks(4,`input`,6,1),Xm(`blur`,function(){return c._onBlur()})(`click`,function(){return c._onInputClick()})(`change`,function(p){return c._onInteractionEvent(p)}),ld(),Wm(6,`div`,7),Ks(7,`div`,8),Qp(),Ks(8,`svg`,9),Wm(9,`path`,10),ld(),Xp(),Wm(10,`div`,11),ld(),Wm(11,`div`,12),ld(),Ks(12,`label`,13,2),IC(14),ld()()),n&2){let t=SC(2);zm(`labelPosition`,c.labelPosition),ab(4),fa(`mdc-checkbox--selected`,c.checked),zm(`checked`,c.checked)(`indeterminate`,c.indeterminate)(`disabled`,c.disabled&&!c.disabledInteractive)(`id`,c.inputId)(`required`,c.required)(`tabIndex`,c.disabled&&!c.disabledInteractive?-1:c.tabIndex),cd(`aria-label`,c.ariaLabel||null)(`aria-labelledby`,c.ariaLabelledby)(`aria-describedby`,c.ariaDescribedby)(`aria-checked`,c.indeterminate?`mixed`:null)(`aria-controls`,c.ariaControls)(`aria-disabled`,c.disabled&&c.disabledInteractive?!0:null)(`aria-expanded`,c.ariaExpanded)(`aria-owns`,c.ariaOwns)(`name`,c.name)(`value`,c.value),ab(7),zm(`matRippleTrigger`,t)(`matRippleDisabled`,c.disableRipple||c.disabled)(`matRippleCentered`,!0),ab(),zm(`for`,c.inputId)}},dependencies:[HG,m],styles:[`.mdc-checkbox {
...
`],encapsulation:2})}return a})();function Ne(a,k){if(a&1&&(Ks(0,`p`,8),YC(1),ld()),a&2){let e=DC();ab(),md(` Showing `,e.filteredCount(),` after client filters (table shows full store; use search in command palette for flash-to-row). `)}}var fe=class a{api=h(d);config=h(c);query=Lt(``);modifiedOnly=Lt(!1);restartOnly=Lt(!1);includeInjected=Lt(!1);filteredCount=yT(()=>this.applyFilters(this.config.entries()).length);ngOnInit(){this.config.load()}onQuery(){}toggleInjected(k){this.includeInjected.set(k),this.api.effectiveConfig({includeInjected:k}).subscribe(e=>{e.ok&&this.config.entries.set(e.data)})}applyFilters(k){let e=k,n=this.query().trim().toLowerCase();return n&&(e=e.filter(c=>c.key.toLowerCase().includes(n)||String(c.label||``).toLowerCase().includes(n)||String(c.effective??c.value??``).toLowerCase().includes(n))),this.modifiedOnly()&&(e=e.filter(c=>c.set&&c.source!=="default")),this.restartOnly()&&(e=e.filter(c=>{let t=String(c.tier||c.applyTier||``).toLowerCase();return t.includes(`restart`)||t===`redeploy`})),e}static ɵfac=function(e){return new(e||a)};static ɵcmp=Xn({type:a,selectors:[[`ao-settings-page`]],decls:19,vars:7,consts:[[1,`mx-auto`,`flex`,`w-full`,`max-w-7xl`,`flex-auto`,`flex-col`,`gap-4`,`p-6`,`lg:px-8`,`lg:pt-8`,`lg:pb-10`],[1,`text-xl`,`font-semibold`,`tracking-tighter`,`sm:text-2xl`],[1,`text-neutral-500`],[1,`flex`,`flex-wrap`,`items-center`,`gap-4`],[`appearance`,`outline`,`subscriptSizing`,`dynamic`,1,`min-w-64`],[`matInput`,``,`placeholder`,`key or value`,3,`ngModelChange`,`ngModel`],[3,`change`,`checked`],[3,`title`,`groups`],[1,`text-sm`,`text-neutral-500`]],template:function(e,n){e&1&&(Ks(0,`div`,0)(1,`div`)(2,`div`,1),YC(3,` All settings `),ld(),Ks(4,`div`,2),YC(5,` Every key with provenance — injected Kubernetes env hidden by default `),ld()(),Ks(6,`div`,3)(7,`mat-form-field`,4)(8,`mat-label`),YC(9,`Filter`),ld(),Ks(10,`input`,5),yy(`ngModelChange`,function(t){return eT(n.query,t)||(n.query=t),t}),Xm(`ngModelChange`,function(){return n.onQuery()}),ld(),qb(),ld(),Ks(11,`mat-checkbox`,6),Xm(`change`,function(t){return n.modifiedOnly.set(t.checked)}),YC(12,` Modified from default `),ld(),Ks(13,`mat-checkbox`,6),Xm(`change`,function(t){return n.restartOnly.set(t.checked)}),YC(14,` Requires restart `),ld(),Ks(15,`mat-checkbox`,6),Xm(`change`,function(t){return n.toggleInjected(t.checked)}),YC(16,` Show injected environment `),ld()(),Wm(17,`ao-config-settings-table`,7),oC(18,Ne,2,1,`p`,8),ld()),e&2&&(ab(10),my(`ngModel`,n.query),Yb(),ab(),zm(`checked`,n.modifiedOnly()),ab(2),zm(`checked`,n.restartOnly()),ab(2),zm(`checked`,n.includeInjected()),ab(2),zm(`title`,null)(`groups`,null),ab(),iC(n.query()||n.modifiedOnly()||n.restartOnly()?18:-1))},dependencies:[J,_n,Pe,mn,Ht,lt,pe,Rt,ge,je],encapsulation:2})};export{fe as SettingsPage};